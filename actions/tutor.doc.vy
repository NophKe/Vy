    ******************************************
    ****    Welcome To The Vy Tutoriel    ****
    ******************************************

NOTE:
-----
  The Vy tutorial is based on the well-known "vimtutor".  If you've
  allready tried to follow it, you will find this document pretty similar.
...
Vy is an editor that has many commands, too many to explain in a tutor
such as this.  This tutor is designed to describe enough of the commands
that you will be able to easily use Vy as an all-purpose editor.
...
----------     
  ...
  file to practice on (if you started "vy --tutor" this is already a
  copy).
...
-----  
  ...
  If you allready are familiar with Vim, go directly on lesson 3.
...
NOTE:
-----
  If you are ever unsure about something you typed, press <ESC> to place
  you in Normal mode.  Then retype the command you wanted.

  The cursor keys should also work.  But using hjkl you will be able to
...
ATTENTION:
----------
  Before executing any of the steps below, read this entire lesson!!
...
3. Get back here by executing the command that got you into this tutor. That
  might be:  vy --tutor <ENTER>

4. If you have these steps memorized and are confident, execute steps 1
  through 3 to exit and re-enter the editor.
